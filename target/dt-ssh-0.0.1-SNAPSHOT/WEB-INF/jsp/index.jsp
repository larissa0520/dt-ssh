...
<head>
    <meta charset="UTF-8">
    <title>容灾管理系统</title>
	<link rel="shortcut icon" href="${pageContext.request.contextPath}/images/logo1.ico">
            ...
            <div class="sidebar-collapse">
                ...
                <!--     <li>
                        ...
                        <ul class="nav nav-second-level">
                        	<li><a class="J_menuItem" href="schedule/job/index">任务管理</a></li>
                        	<li><a class="J_menuItem" href="schedule/joblog/index">任务日志</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="sys/user/index">用户管理</a></li>
							<li><a class="J_menuItem" href="sys/role/index">角色管理</a></li>
                            <li><a class="J_menuItem" href="sys/menu/index">菜单管理</a></li>
                            <li><a class="J_menuItem" href="sys/config/index">参数管理</a></li>
                            <li><a class="J_menuItem" href="#">SQL监控</a></li>
							<li><a class="J_menuItem" href="#">组织管理</a></li>
							<li><a class="J_menuItem" href="#">系统日志</a></li>
							<li><a class="J_menuItem" href="#">代码生成器</a></li>
                        </ul>
                    </li>
                    <li>
				        <a href="#"> 
				          <i class="fa fa fa-bar-chart-o"></i> 
				          <span class="nav-label">测试管理</span> <span class="fa arrow"></span>
					    </a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="report?method=list">运营统计报表</a></li>
							<li><a class="J_menuItem" href="report?method=list_daily">运营统计日报表</a></li>
							<li><a class="J_menuItem" href="report?method=list_detail">运营统计详单</a></li>
					   </ul>
				  </li> -->
