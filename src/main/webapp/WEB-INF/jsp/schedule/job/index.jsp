...
<body class="my-content">
  ...
  <div id="dtApp" v-cloak>
		<div id="toolbar">
			<shiro:hasPermission name="schedule:job:save">
				<a href="form?add" class="btn btn-success " type="button">
					<i class="fa fa-plus"></i>&nbsp;&nbsp;<span class="bold">新增</span>
		        </a>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="schedule:job:delete">
		        <button class="btn btn-danger " type="button" @click="deleteBatch">
					<i class="fa fa-remove"></i>&nbsp;&nbsp;<span class="bold">删除</span>
		        </button>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="schedule:job:pause">
		        <button class="btn btn-success " type="button" @click="pauseBatch">
					<i class="fa fa-pause"></i>&nbsp;&nbsp;<span class="bold">暂停</span>
		        </button>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="schedule:job:resume">
		        <button class="btn btn-success " type="button" @click="resumeBatch">
					<i class="fa fa-play"></i>&nbsp;&nbsp;<span class="bold">启动</span>
		        </button>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="schedule:job:run">
		        <button class="btn btn-success " type="button" @click="runBatch">
					<i class="fa fa-arrow-circle-right"></i>&nbsp;&nbsp;<span class="bold">立即执行</span>
		        </button>
	        </shiro:hasPermission>
		</div>
	...
	<!-- 模块 -->
	<script src="${pageContext.request.contextPath}/script/modules/schedule/job/index.js"></script>
